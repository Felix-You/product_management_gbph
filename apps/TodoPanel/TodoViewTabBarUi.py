...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox_timespace = QtWidgets.QComboBox(Form)
        self.comboBox_timespace.setObjectName("comboBox_timespace")
        self.horizontalLayout_2.addWidget(self.comboBox_timespace)
        ...
        self.verticalLayout.addWidget(self.tableWidget_header)
        self.todoPanelScroll = QtWidgets.QScrollArea(Form)
        self.todoPanelScroll.setWidgetResizable(True)
        self.todoPanelScroll.setObjectName("todoPanelScroll")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1297, 1235))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.todoPanelScroll.setWidget(self.scrollAreaWidgetContents)
        self.verticalLayout.addWidget(self.todoPanelScroll)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setText(_translate("Form", "时空距离"))
